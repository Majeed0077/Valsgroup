...
const Dashboard = () => {
  ...
  return (
    <div className={styles.dashboard}>
      ...
      {/* Weather Card */}
      <div className={styles['weather-card']} role="region" aria-label="Weather information">
        <div className={styles['weather-info']}>
          <div className={styles.temp}>20°</div>
          <div className={styles.location}>Karachi, Pakistan</div>
        </div>
        <div className={styles['weather-icon']} aria-label="Rainy weather icon">
      ...
      <div className={styles.engine}>
        ...
        <label className={styles['toggle-switch']} tabIndex={0} aria-label="Engine switch toggle">
          <input
            type="checkbox"
            checked={engineOn}
        ...
        <div className={styles.clock} aria-label="Analog clock">
          <svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" role="img" aria-hidden="false">
            ...
            <line
              ...
              x2="32"
              y2="14"
              style={{ transformOrigin: '32px 32px', transform: `rotate(${hourAngle}deg)` }}
            />
            <line
              ...
              x2="48"
              y2="32"
              style={{ transformOrigin: '32px 32px', transform: `rotate(${minuteAngle}deg)` }}
            />
            <line
              ...
              x2="32"
              y2="52"
              style={{ transformOrigin: '32px 32px', transform: `rotate(${secondAngle}deg)` }}
            />
          </svg>
        </div>
      </div>
      ...
      <div className={`${styles.card} ${styles.saving}`}>
        ...
        <div className={styles.chart}>
          <svg viewBox="0 0 400 160" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
            <defs>
            ...
            <path
              ...
              "
            />
            <line x1="310" y1="0" x2="310" y2="160" stroke="#3f57ff" strokeWidth="1" />
          </svg>
          <div className={styles['highlight-circle']} style={{ left: '310px' }}></div>
      ...
      <div className={`${styles.card} ${styles.donut}`}>
        ...
        <div className={styles.legend}>
          <div>
            <span className={`${styles['color-box']} ${styles['option-a-box']}`}></span>Option A{' '}
            <span className={styles.percent}>60%</span>
          </div>
          <div>
            <span className={`${styles['color-box']} ${styles['option-b-box']}`}></span>Option B{' '}
            <span className={styles.percent}>20%</span>
          </div>
          <div>
            <span className={`${styles['color-box']} ${styles['option-c-box']}`}></span>Option C{' '}
            <span className={styles.percent}>20%</span>
          </div>
        </div>
      </div>
      ...
      <div className={`${styles.card} ${styles['daily-time']}`}>
        ...
        <div className={styles['avg-label']}>Average time you spent per day</div>
        ...
        <div className={styles['bar-chart-with-labels']}>
          {['m', 't', 'w', 'th', 'f', 's', 'today'].map((day) => (
            <div key={day} className={styles['bar-with-label']}>
              ...
              <div className={styles.label}>{day === 'th' ? 'T' : day.charAt(0).toUpperCase()}</div>
            </div>
          ))}
        </div>
        ...
        <div className={styles.reminder}>
          ...
          <div className={styles['reminder-subtitle']}>Reminder after you reached daily limit</div>
        </div>
      </div>
      ...
      <div className={`${styles.card} ${styles.overspeed}`}>
        ...
        <div className={styles.gauge} aria-label="Overspeed gauge">
          <svg viewBox="0 0 160 100" xmlns="http://www.w3.org/2000/svg" role="img" aria-hidden="false">
            <defs>
            ...
            <path d="M 10 90 A 70 70 0 0 1 150 90" fill="none" stroke="#ddd" strokeWidth="18" />
            <path
      ...
      <div className={`${styles.card} ${styles['hours-spent']}`}>
        ...
        <div className={styles.subheader}>
          <span className={styles['big-number']}>22.6</span> <small>Hours spent</small>
        </div>
        <div className={styles['bar-chart-horizontal']}>
          {[
            { label: 'Jun', blue: '20%', green: '8%', grey: '40%', greenLeft: '20%', greyLeft: '28%' },
            { label: 'May', blue: '37%', green: '21%', grey: '30%', greenLeft: '37%', greyLeft: '58%' },
            { label: 'Apr', blue: '23%', green: '12%', grey: '40%', greenLeft: '23%', greyLeft: '35%' },
            { label: 'Mar', blue: '43%', green: '15%', grey: '22%', greenLeft: '43%', greyLeft: '58%' },
            { label: 'Feb', blue: '12%', green: '12%', grey: '50%', greenLeft: '12%', greyLeft: '24%' },
            { label: 'Jan', blue: '30%', green: '15%', grey: '40%', greenLeft: '30%', greyLeft: '45%' },
            ...
            <div key={label} className={styles['bar-row']}>
              ...
              <div className={styles.bar} style={{ position: 'relative' }}>
                ...
                <div
                  ...
                  style={{ left: greenLeft, width: green, position: 'absolute', top: 0, bottom: 0 }}
                ></div>
                <div
                  className={styles.grey}
                  style={{ left: greyLeft, width: grey, position: 'absolute', top: 0, bottom: 0, opacity: 0.3 }}
                ></div>
              </div>
            </div>
          ))}
